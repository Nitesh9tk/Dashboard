    ...
    <div className="flex min-h-screen items-center justify-center bg-bg-primary px-4 py-12 sm:px-6 lg:px-8 relative overflow-hidden transition-colors duration-300">
      ...
      <div className="w-full max-w-md space-y-6 glass-panel p-8 rounded-2xl border border-border-primary shadow-xl relative z-10">
        ...
        <div className="text-center">
          <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-brand-primary text-bg-primary font-semibold text-2xl tracking-wider mb-2 shadow-md">
            BB
          </div>
          ...
          <form onSubmit={handleSendOtp} className="space-y-4">
            <div>
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none text-xs font-medium text-text-secondary">
                  +91
                </div>
                <input
                  type="tel"
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-bg-secondary border border-border-primary text-text-primary rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-accent/20 focus:border-brand-accent transition-all text-sm font-medium tracking-wider"
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 px-4 bg-brand-primary text-bg-primary hover:bg-brand-primary/95 text-xs font-semibold rounded-xl transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          <form onSubmit={handleVerifyOtp} className="space-y-4">
            <div>
              ...
              <span className="text-[10px] text-text-secondary mt-2 block text-left">
                Didn&apos;t get the OTP? Use sandbox fallback <span className="font-medium text-brand-accent">123456</span> or click Resend.
              </span>
            </div>
            ...
            <div className="flex gap-3">
              <button
                type="button"
                onClick={() => setStep(1)}
                className="py-3 px-4 border border-border-primary hover:bg-bg-secondary text-text-secondary hover:text-text-primary text-xs font-semibold rounded-xl transition-all flex items-center justify-center gap-1.5 cursor-pointer"
              >
